...
**Master's student in Data Analytics Engineering** · AI/ML · Data Science · Data Analytics
...
- Strong foundation in Python, SQL, statistics, machine learning, and data analysis
- Experience across EDA, ETL, dashboarding, model evaluation, and analytical reporting
- Comfortable working with structured and unstructured data to build clear, reproducible, and decision-ready outputs
- Interested in roles involving AI/ML, data science, data analytics, predictive modeling, and business intelligence
- Known for translating data into insights, metrics, and action
...
| **Analytics** | Pandas, NumPy, Jupyter Notebook, Excel, Tableau, Power BI |
| **Machine Learning** | Scikit-learn, XGBoost, TensorFlow, PyTorch |
| **Statistics** | Regression, classification, clustering, time series, hypothesis testing, A/B testing |
| **Databases** | MySQL, PostgreSQL, MongoDB, SQLite |
| **Backend** | Node.js, Express, Flask |
| **Frontend** | React, HTML, CSS |
| **Tools** | Git, GitHub, Linux, VS Code, Railway, AWS |

**Core focus areas:** data cleaning & validation · EDA & feature engineering · hypothesis/A/B testing · predictive modeling (classification, regression, clustering) · time-series analysis & KPI reporting · dashboard development & data storytelling · API-based data workflows & automation
...
- Created and optimized dashboards and API-backed reporting views in Tableau, Power BI, Flask, and React to improve accessibility of business metrics for stakeholders.
- Used Git, GitHub, Excel, Python, and SQL to prepare datasets, analyze KPIs, and support recurring business questions.
- Collaborated with engineering and product teams to convert business needs into clear metric definitions, reporting logic, and analytical deliverables.
- Automated recurring reporting workflows with Python scripts and SQL queries, reducing manual effort and improving turnaround time for business updates.
- Built reusable analysis notebooks in Jupyter Notebook to standardize exploratory analysis, metric validation, and result presentation.
- Worked with structured datasets across multiple sources to perform data cleaning, normalization, and transformation before downstream analysis.
- Supported stakeholder reporting by translating raw data into actionable KPIs, trend summaries, and decision-ready insights.
- Applied statistical thinking to compare segments, validate patterns, and explain performance changes in a clear and measurable way.
...
| **Customer Churn & Pricing Optimization** | EDA, feature engineering, classification, model evaluation | Python, Scikit-learn, XGBoost, PyTorch, Streamlit |
| **Sales Analytics Dashboard** | KPI analysis, predictive modeling, time-series insight | Python, Pandas, Tableau, SQL |
| **NFT Theft Tracker** | Database design, ETL, SQL analytics, REST API development | MySQL, Node.js, React, Railway |
...
**MET Institute of Engineering** — BE, Electronics & Telecommunication
`May 2022` · GPA: 3.4
...
> Building data and ML solutions that are technically sound, easy to understand, and useful in the real world.
